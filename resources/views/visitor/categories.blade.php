            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle m-0">
                    ...
                    <tbody style="font-size: 13.5px;">
                        ...
                        <tr>
                            <td class="fw-bold text-dark" style="padding: 12px;">{{ $cat->nama_kategori }}</td>
                            <td style="padding: 12px; color: #495057;">
                                {{ $cat->keterangan ?? '(Tidak ada keterangan)' }}
                            </td>
                            <td class="text-center" style="padding: 12px;">
                                <a href="{{ route('visitor.home', ['category' => $cat->nama_kategori]) }}" class="btn btn-sm rounded-pill text-white px-3" style="background-color: #2e7d32; font-size: 12px;">
                                    Lihat Artikel →
                                </a>
                            </td>
                        </tr>
